Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	ЗаполнитьРегистрНакопленияПродажиНоменклатуры(Отказ);
КонецПроцедуры
...
Процедура ЗаполнитьРегистрНакопленияПродажиНоменклатуры(Отказ)
	...
	Пока ВыборкаНоменклатура.Следующий() Цикл
			...
			Иначе
					Себестоимость = ВыборкаДетальныеЗаписи.Количество / ВыборкаДетальныеЗаписи.КоличествоОстаток * ВыборкаДетальныеЗаписи.СуммаОстаток;
			КонецЕсли;
